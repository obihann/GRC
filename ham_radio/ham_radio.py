...
class ham_radio(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Ham Radio")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Ham Radio")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ham_radio")
        ...
        self.channel_freq = channel_freq = 146.97e6
        ...
        # Blocks
        ##################################################
        self._channel_freq_range = Range(144e6, 148e6, 1e4, 146.97e6, 100)
        self._channel_freq_win = RangeWidget(self._channel_freq_range, self.set_channel_freq, 'Frequency', "counter_slider", float)
        self.top_grid_layout.addWidget(self._channel_freq_win)
        self._audio_gain_range = Range(0, 100, 1, 1, 100)
        self._audio_gain_win = RangeWidget(self._audio_gain_range, self.set_audio_gain, 'Gain', "counter_slider", float)
...
def main(top_block_cls=ham_radio, options=None):
